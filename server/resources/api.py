...
from server.views.topograms import TopogramListView, TopogramWordsView, TopogramCitationsView, TopogramsByDataset, TopogramView, TopogramTimeFramesList, TopogramTimeFramesView
...
api.add_resource(TopogramWordsView, '/api/v1/topograms/<int:topogram_id>/words/<int:words_limit>')
